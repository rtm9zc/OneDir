...
if __name__ == "__main__":
    server = FileIOServerFactory("/home/student/cpn2pf/OneDir/test_user")
    # my laptop
    lm_one = LocalMachine('testUser', "home/student/cpn2pf/OneDir/test_user", address='127.0.0.1', send_port=1234, listen_port=1235)
    # lab desktop
